...
<head>
    ...
    <title>ใบสมัครงาน - บริษัท ดวงรักษา จำกัด</title>
...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-10">
                    ...
                    <p class="subtitle">บริษัท ดวงรักษา  จำกัด - สมัครงานกับเราและร่วมเป็นส่วนหนึ่งของทีมเทคโนโลยีชั้นนำ</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <!-- Footer -->
        <div class="footer">
            <p><i class="fas fa-phone me-1"></i> โทรศัพท์: 065-428-6908 | <i class="fas fa-envelope me-1"></i> อีเมล: 66010914007@mau.ac.th</p>
            <p class="mt-3">© 2023 บริษัท ดวงรักษา จำกัด. สงวนลิขสิทธิ์.</p>
        </div>
    </div>
    ...
    if (isset($_POST['Submit'])) {
        ...
        $sql = "INSERT INTO `application` (`a_id`, `a_title`, `a_fullname`, `a_birthday`, `a_education`, `a_position`, `a_skill`, `a_experience`) 
                VALUES (NULL, '$title', '$fullname', '$birthday', '$education', '$position', '$skill', '$experience')";

        
        if (mysqli_query($conn, $sql)) {
            echo "<script>";
            echo "alert('บันทึกข้อมูลการสมัครเรียบร้อยแล้ว');";
            echo "window.location.href='bb.php';";
            echo "</script>";
        } else {
